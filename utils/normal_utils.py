...
def depth2point(depth_image, intrinsic_matrix, extrinsic_matrix, view_space=False):
...
def normal_from_depth_image(depth, intrinsic_matrix, extrinsic_matrix, view_space=False, offset=None):
    # depth: (H, W), intrinsic_matrix: (3, 3), extrinsic_matrix: (4, 4)
    # xyz_normal: (H, W, 3)
    xyz_world = depth2point(depth, intrinsic_matrix, extrinsic_matrix, view_space) # (H, W, 3)
    xyz_world = xyz_world.reshape(*depth.shape, 3)
    xyz_normal = depth_pcd2normal(xyz_world, offset) # in world space, modify depth2point_world for camera space
