...
class Config:
    ...
    eval_steps: List[int] = field(default_factory=lambda: [7_000, 15_000, 20_000, 30_000])
    # Steps to save the model
    save_steps: List[int] = field(default_factory=lambda: [7_000, 15_000, 20_000, 30_000])
    # Whether to save ply file (storage size can be large)
    save_ply: bool = False
    # Steps to save the model as ply
    ply_steps: List[int] = field(default_factory=lambda: [7_000, 15_000, 20_000, 30_000])
    ...
    def eval(self, step: int, stage: str = "val"):
        ...
        for i, data in enumerate(valloader):
            ...
            if world_rank == 0:
                ...
                # imageio.imwrite(f"{self.eval_dir}/{stage}_step{step}_{i:04d}.png", canvas)
