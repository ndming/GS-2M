...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        num_rendered, color, radii, geomBuffer, binningBuffer, imgBuffer, inv_depth = _C.rasterize_gaussians(*args)
        ...
        return color, radii, inv_depth

    @staticmethod
    def backward(ctx, grad_color, _, grad_inv_depth):
